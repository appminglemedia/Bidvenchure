        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                ...
                return Row(
                  children: [
                    Radio<String>(
                      ...
                      activeColor: const Color(0xff5569fe),
                      onChanged: (value) {
              ...
              Obx(() {
                return signupController.selectedRole.value == 'Organization'
                    ? Column(
                        children: [
                          const SizedBox(
                            height: 10,
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              focusedBorder: const OutlineInputBorder(
                                  ...
                                  borderSide:
                                      BorderSide(color: Color(0xff5669ff))),
                              border: const OutlineInputBorder(
                                borderRadius: BorderRadius.all(
                                  Radius.circular(12),
                                ),
                                borderSide:
                                    BorderSide(color: Color(0xffE4DFDF)),
                              ),
                              prefixIcon: Padding(
                                ...
                                child: SvgPicture.asset(
                                  ...
                                  height: 22,
                                  color: Colors
                                      .grey, // Optional: Apply a color to the icon
                                ),
                              ),
                            ),
                          ),
                          ...
                          TextField(
                            decoration: InputDecoration(
                                ...
                                prefixIcon: Image.asset("assets/images/gst.png")
                                // Icon(
